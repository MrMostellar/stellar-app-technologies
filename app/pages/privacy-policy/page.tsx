...
export const metadata: Metadata = {
  ...
  description: "We respect your privacy, feel free to read all about it.",
};

export default function page() {
  return (
    <>
      <section className="pt-32 space-y-5 mx-40 [&>h1]:text-center [&>h2]:text-center [&>h3]:text-center [&>h4]:text-center">
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Stellar App Technologies LLC.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Stellar App Technologies,
              accessible from{" "}
              <a
                href="https://www.stellarapptechnologies.com"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://www.stellarapptechnologies.com
              </a>
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>By email: admin@stellarapptechnologies.com</li>
        </ul>
      </section>
    </>
  );
