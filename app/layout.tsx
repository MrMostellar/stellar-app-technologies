  ...
  return (
    <html lang="en">
      <body>
        ...
        <div className="flex flex-col min-h-[100vh] min-w-[100%] overflow-y-auto bg-black">
          ...
          <div className="flex-1 flex flex-col text-center min-w-[100%] min-h-[100%] bg-red-300">
            <Footer />
          </div>
        </div>
      </body>
