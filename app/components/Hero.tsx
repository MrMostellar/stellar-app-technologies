...
export default function Hero() {
  return (
    <>
      <div className="p-4 flex flex-col col-start-2 col-span-6 row-span-3 justify-center items-center rounded-3xl m-4 bg-transparent">
        <h1 className="p-4 text-lg">Pellentesque leo</h1>
        <p>
      ...
      <div className="p-4 flex flex-col col-start-6 row-start-5 col-span-6 row-span-3 justify-center items-center rounded-3xl m-4 bg-transparent">
        <h1 className="p-4 text-lg">Donec nec vestibulum</h1>
        <p>
      ...
      <div className="p-4 flex flex-col col-start-2 row-start-9 col-span-6 row-span-3 justify-center items-center rounded-3xl m-4 bg-transparent">
        <h1 className="p-4 text-lg">Mauris placerat</h1>
        <p>
