...
export default function Home() {
  return (
    <>
      <section className="text-[0.rem] px-40 z-1 bg-[url('/images/bgSpace1.jpg')] bg-no-repeat bg-cover pt-32 grid min-h-[101vh] min-w-[100%] grid-cols-12 grid-rows-12 sm:grid-cols-24 sm:grid-rows-24 gap-1">
        <Hero />
      </section>
