...
export default function Home() {
  return (
    <>
      <section className="text-[0.rem] px-40 z-1 bg-[url('/images/bgSpace1.jpg')] bg-no-repeat bg-cover pt-32 grid min-h-[101vh] max-w-[100%] xs:grid-cols-24 grid-rows-24 gap-1">
        <Hero />
      </section>
